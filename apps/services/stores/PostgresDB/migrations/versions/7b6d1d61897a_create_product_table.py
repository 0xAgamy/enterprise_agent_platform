...
Revision ID: 7b6d1d61897a
Revises: ac9d475e19f3
Create Date: 2026-09-08 17:46:53.241599
...
revision: str = '7b6d1d61897a'
down_revision: Union[str, Sequence[str], None] = 'ac9d475e19f3'
...
def upgrade() -> None:
    ...
    sa.Column('parent_asin', sa.String(length=255), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('rating_number', sa.Integer(), nullable=True),
    sa.Column('image', sa.String(length=255), nullable=True),
    sa.Column('average_rating', sa.Float(precision=2), nullable=True),
